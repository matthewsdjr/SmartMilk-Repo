...
#dlp_nano_lib = ctypes.CDLL('./libtest.so')
dlp_nano_lib = ctypes.CDLL("C:/ti/DLPSpectrumLibrary_2.0.3/src/dlpspec.dll")
...
def unpack_fields(result_in):
    ...
    for field_name, field_type in result_in._fields_:
        ...
        try:
            dict_[field_name] = unpack_fields(getattr(result_in, field_name))
